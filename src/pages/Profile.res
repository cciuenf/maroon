...
let default = () => {
  ...
  <div className="flex bg-blue-500 h-screen"> // div absoluta, corpo da pagina
    <div className="flex flex-row font-sans sm:space-x-8 md:space-x-24 lg:space-x-0"> // div que contém os dados a esquerda e direita
      <div className="flex flex-col space-y-10 w-2/6 items-center mt-12 sm:mr-12 sm:ml-24 md:ml-48 lg:ml-96"> // div a esquerda
        <div className="flex flex-col space-y-6 uppercase text-white items-center"> //div nome foto participaçao
          <div className="bg-blue-100 rounded-full"> // div foto
        ...
        <div className="flex flex-col space-y-3 text-blue-700"> // div botões
      ...
      <div className="flex flex-col w-4/6 text-white mt-24"> // div direita
